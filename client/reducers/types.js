...
export const SET_USER_IMAGE_REQUEST = 'SET_USER_IMAGE_REQUEST';
export const SET_USER_IMAGE_SUCCESS = 'SET_USER_IMAGE_SUCCESS';
export const SET_USER_IMAGE_FAILURE = 'SET_USER_IMAGE_FAILURE';
...
export const CREATE_DIRECT_SUBSCRIBE = 'CREATE_DIRECT_SUBSCRIBE';
export const CREATE_DIRECT_SUCCESS = 'CREATE_DIRECT_SUCCESS';
export const CREATE_DIRECT_FAILURE = 'CREATE_DIRECT_FAILURE';
...
export const CREATE_ROOM_SUBSCRIBE = 'CREATE_ROOM_SUBSCRIBE';
...
export const SEND_CHAT_SUBSCRIBE = 'SEND_CHAT_SUBSCRIBE';
export const SEND_CHAT_SUCCESS = 'SEND_CHAT_SUCCESS';
export const SEND_CHAT_FAILURE = 'SEND_CHAT_FAILURE';

export const GET_CHATS_OF_ROOM = 'GET_CHATS_OF_ROOM';
